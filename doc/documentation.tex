...
\begin{figure}[h]
  ...
  \resizebox{!}{5cm}{
    \centering
    \includegraphics[scale=1]{images/board_capture.png} 
  }
  \end{flushleft}
\end{figure}
...
\begin{figure}[h]
  ...
  \resizebox{13.5cm}{!}{
    \centering
    \includegraphics[scale=1]{images/playing_tree.png} 
  }
\end{figure}
...
\begin{figure}[h]
  ...
  \resizebox{13.5cm}{!}{
    \centering
    \includegraphics[scale=1]{images/minimax_example.png} 
  }
\end{figure}
...
\begin{figure}[h]
  ...
  \resizebox{13.5cm}{!}{
    \centering
    \includegraphics[scale=1]{images/minimax_d1_example.png} 
  }
\end{figure}
...
\begin{figure}[h]
  ...
  \resizebox{13.5cm}{!}{
    \centering
    \includegraphics[scale=1]{images/minimax_d2_example.png}
  }
\end{figure}
...
\begin{figure}[h]
  ...
  \resizebox{15cm}{!}{
    \centering
    \includegraphics[scale=1]{images/minimax_ab_example.png}
  }
\end{figure}
...
\end{ocamldoccode}
\index{make-underscoreothello-underscoreboard@\verb`make_othello_board`}
